...
PREGUNTA DE ENTREVISTA QUE DIFERENCIA HAY ENTRE FOREACH (se utiliza para mostrar por consola la info) 
Y MAP (para crear nuevos arrays).
...
/*
THIS
no se puede utilizar con funcion de flecha
...
let Fecha = {
    ...
    faltante:() {
        ...
        console.log(`faltan ${31 - this.dia} dias para terminar el  mes`);
        console.log(`faltan ${12 - this.mes} meses para terminar el año`);
        console.log(`hoy es ${this.dia}/${this.mes}/${this.año} y faltan
        ${12 - this.mes}meses y ${31 - this.dia}dias para terminar el año`);
    }
}
Fecha.faltante();
